...
model1 = ensemble.RandomForestRegressor(max_depth=20, random_state=42, n_jobs = -1, n_estimators = 100)
model1.fit(train[col], np.log1p(train['visitors'].values))
print('RMSE RandomForestRegressor: ', RMSLE(np.log1p(train['visitors'].values), model1.predict(train[col])))
print('RMSE RandomForestRegressor: ', RMSLE(np.log1p(test['visitors'].values), model1.predict(test[col])))
